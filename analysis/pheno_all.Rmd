...
# Join
df_anl_pmodel_orig <- df_orig_wide %>% 
  left_join(pep725_pmodel)
```
...
#fit_iav_pep_off_vs_gppnet = lmer(off ~ scale(gpp_net) + (1|sitename), data = df_anl_pmodel_zz, na.action = "na.exclude")
