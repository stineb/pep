...
ggsave("~/pep/manuscript/fig_1.png", width = 9, height = 6, dpi=300)
...
ggsave("~/pep/manuscript/fig_1b.png", width = 13, height = 8, dpi=300)
...
qq <- gg_modis_mean_gppnet + gg_modis_anom_gppnet
qq + plot_annotation(tag_levels = 'A')
...
plot_grid(map_gpp,map_eos,align = "v", ncol = 1, nrow = 2, rel_heights = c(1, 1),rel_widths = c(1, 1))

rr <- map_gpp / map_eos
rr + plot_annotation(tag_levels = list(c('C', 'D')))

ggsave("~/pep/manuscript/maps.png", width = 8, height = 8)
```
