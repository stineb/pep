...
pp <- (ff_iav_pep_off_vs_cAtot + ff_lt_pep_off_vs_cAtot + ff_lt_pep_off_vs_year2)/(ff_iav_pep_off_vs_gppnet + ff_lt_pep_off_vs_gppnet + ff_lt_pep_off_vs_year3)
pp + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_1_Sc.png", width = 9, height = 6, dpi=300)
...
ss1 <- (ff_iav_pep_off_vs_on + ff_lt_pep_off_vs_on + ff_lt_pep_off_vs_year1) / (ff_lt_pep_on_vs_year + ff_lt_pep_cAtot_vs_year + ff_lt_pep_gppnet_vs_year)
ss1 + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_2_Sc.png", width = 9, height = 6, dpi=300)
...
ss2 <- (ff_lt_modis_off_vs_on + ff_lt_modis_off_vs_year1 + ff_lt_modis_on_vs_year) / (ff_modis_mean_gppnet + ff_modis_anom_gppnet + ff_lt_modis_gppnet_vs_year)
ss2 + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_3_Sc.png", width = 9, height = 6, dpi=300)
...
rr <- map_gpp / map_eos
rr + plot_annotation(tag_levels = list(c('A', 'B')))

ggsave("~/pep/manuscript/fig_4_Sc.png", width = 8, height = 8, dpi=300)
```
