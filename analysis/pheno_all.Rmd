...
gg_lt_pep_off_vs_year <- gg_lt_pep_off_vs_year + ylab("SOS (DOY)") 
...
fit_lt_modis_anom_gppnet = lmer(off ~ scale(mean_gpp_net) + scale(anom_gpp_net) + scale(year) + (1|sitename), data = df_modis, na.action = "na.exclude")
...
pp <- ff_lt_pep_off_vs_cAtot + ff_lt_pep_off_vs_year2 + ff_iav_pep_off_vs_cAtot
pp + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_1.png", width = 8, height = 3, dpi=300)

pp <- ff_lt_pep_off_vs_gppnet + ff_lt_pep_off_vs_year3 + ff_iav_pep_off_vs_gppnet
pp + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_S1.png", width = 8, height = 3, dpi=300)
...
ff_lt_pep_off_vs_on <- gg_lt_pep_off_vs_on +
  labs(title = expression(paste("EOS ~ ", bold("SOS"), " + Year")), subtitle = "PEP data") 

ff_lt_pep_off_vs_year1 <- gg_lt_pep_off_vs_year1 +
  labs(title = expression(paste("EOS ~ SOS + ", bold("Year"))), subtitle = "PEP data") 
...
ss1 <- ff_lt_pep_off_vs_on + ff_lt_pep_off_vs_year1 + ff_iav_pep_off_vs_on
ss1 + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_2.png", width = 8, height = 3, dpi=300)

ss1 <- ff_lt_pep_cAtot_vs_year + ff_lt_pep_gppnet_vs_year + ff_lt_pep_on_vs_year
ss1 + plot_annotation(tag_levels = 'A')
...
ff_lt_modis_off_vs_on <- gg_lt_modis_off_vs_on +
  labs(title = expression(paste("EOS ~ ", bold("SOS"), " + Year")), subtitle = "MODIS data") 

ff_lt_modis_off_vs_year1 <- gg_lt_modis_off_vs_year1 +
  labs(title = expression(paste("EOS ~ SOS + ", bold("Year"))), subtitle = "MODIS data") 

ff_lt_modis_on_vs_year <- gg_lt_modis_on_vs_year +
...
ff_lt_modis_gppnet_vs_year <- gg_lt_modis_gppnet_vs_year +
  labs(title = expression(paste(italic("A")[net], " ~ Year")), subtitle = "MODIS data and P-model")

ff <- ff_modis_mean_gppnet + ff_modis_anom_gppnet
ff + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_3a.png", width = 7.5, height = 4, dpi=300)

ff <- ff_lt_modis_mean_on + ff_lt_modis_anom_on
ff + plot_annotation(tag_levels = 'A')
ggsave("~/pep/manuscript/fig_S3.png", width = 7.5, height = 4, dpi=300)
...
ff <- (ff_modis_mean_gppnet + ff_modis_anom_gppnet)/map_eos / map_gpp
ff + plot_annotation(tag_levels = 'A') + 
  plot_layout(heights = c(1,2,2))

ggsave("~/pep/manuscript/fig_3b.png", width = 8, height = 6, dpi=300)
```
