...
```{r}
fit_iav_pep_on = lmer(off ~ scale(on) + (1|id_site) + (1|species) , data = df_anl, na.action = "na.exclude")
summary(fit_iav_pep_on)
r.squaredGLMM(fit_iav_pep_on)
plot(allEffects(fit_iav_pep_on))

aic_iav_pep_on <- AIC(fit_iav_pep_on)
out_iav_pep_on <- allEffects(fit_iav_pep_on)
gg_iav_pep_on <- ggplot_on(out_iav_pep_on)
gg_iav_pep_on
```
...
```{r}
fit_iav_pep_cAtot = lmer(off ~ scale(cA_tot) + (1|id_site) + (1|species) , data = df_anl, na.action = "na.exclude")
summary(fit_iav_pep_cAtot)
r.squaredGLMM(fit_iav_pep_cAtot)
plot(allEffects(fit_iav_pep_cAtot))

aic_iav_pep_cAtot <- AIC(fit_iav_pep_cAtot)
out_iav_pep_cAtot <- allEffects(fit_iav_pep_cAtot)
gg_iav_pep_cAtot <- ggplot_cA_tot(out_iav_pep_cAtot)
gg_iav_pep_cAtot
```
...
```{r}
fit_lt_pep_on_year = lmer(off ~ scale(on) + scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_lt_pep_on_year)
r.squaredGLMM(fit_lt_pep_on_year)
plot(allEffects(fit_lt_pep_on_year))

aic_lt_pep_on_year <- AIC(fit_lt_pep_on_year)
out_lt_pep_on_year <- allEffects(fit_lt_pep_on_year)
gg_lt_pep_on <- ggplot_on(out_lt_pep_on_year)
gg_lt_pep_year <- ggplot_year(out_lt_pep_on_year)

gg_lt_pep_on + gg_lt_pep_year
```

Long-term trend in SOS.

```{r}
fit_lt_pep_sos <- lmer(on ~ scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_lt_pep_sos)

out_lt_pep_sos <- allEffects(fit_lt_pep_sos)
gg_lt_pep_sos <- ggplot_year(out_lt_pep_sos)
gg_lt_pep_sos <- gg_lt_pep_sos + ylab("SOS (DOY)") 
gg_lt_pep_sos
```
...
```{r}
fit_lt_pep_cAtot_year = lmer(off ~ scale(cA_tot) + scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_lt_pep_cAtot_year)
r.squaredGLMM(fit_lt_pep_cAtot_year)
plot(allEffects(fit_lt_pep_cAtot_year))

aic_lt_pep_cAtot_year <- AIC(fit_lt_pep_cAtot_year)
out_lt_pep_cAtot_year <- allEffects(fit_lt_pep_cAtot_year)
gg_lt_pep_cAtot <- ggplot_cA_tot(out_lt_pep_cAtot_year)
gg_lt_pep_year <- ggplot_year(out_lt_pep_cAtot_year)

gg_lt_pep_cAtot + gg_lt_pep_year
```
...
fit_lt_Zani_anom = lmer(off ~ scale(mean_cA_tot) + scale(anom_cA_tot) + scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_lt_Zani_anom)
plot(allEffects(fit_lt_Zani_anom))
r.squaredGLMM(fit_lt_Zani_anom)

aic_lt_Zani_anom <- AIC(fit_lt_Zani_anom)
out_plot_lt <- allEffects(fit_lt_Zani_anom)
gg_lt_Zani_mean <- ggplot_mean_cA_tot(out_plot_lt)
gg_lt_Zani_anom <- ggplot_anom_cA_tot(out_plot_lt)
gg_lt_Zani_year <- ggplot_year(out_plot_lt)

gg_lt_Zani_mean + gg_lt_Zani_anom + gg_lt_Zani_year
...
```{r}
fit_iav_pm_gppnet = lmer(off ~ scale(gpp_net) + (1|id_site) + (1|species) , data = df_anl, na.action = "na.exclude")
...
```{r}
fit_lt_pm_gppnet = lmer(off ~ scale(gpp_net) + scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
...
```{r}
fit_anet_pm_year <- lmer(gpp_net ~ scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_anet_pm_year)
plot(allEffects(fit_anet_pm_year))

out_plot_pm_anet <- allEffects(fit_anet_pm_year)
gg_lt_pm_anet_year <- ggplot_year(out_plot_pm_anet)
gg_lt_pm_anet_year <- gg_lt_pm_anet_year + 
  labs(y = expression(italic("A")[net])) 
gg_lt_pm_anet_year
...
gg_dual_pm <- ggplot_year_anet(x = out_plot_lt, y = out_plot_pm_anet)
gg_dual_pm
```
...
fit_lt_pm_anom = lmer(off ~ scale(mean_gpp_net) + scale(anom_gpp_net) + scale(year) + (1|id_site) + (1|species), data = df_anl, na.action = "na.exclude")
summary(fit_lt_pm_anom)
plot(allEffects(fit_lt_pm_anom))
r.squaredGLMM(fit_lt_pm_anom)

aic_lt_pm_anom <- AIC(fit_lt_pm_anom)
out_plot_lt <- allEffects(fit_lt_pm_anom)
gg_lt_pm_mean <- ggplot_mean_gpp_net(out_plot_lt)
gg_lt_pm_anom <- ggplot_anom_gpp_net(out_plot_lt)
gg_lt_pm_year <- ggplot_year(out_plot_lt)

gg_lt_pm_mean + gg_lt_pm_anom + gg_lt_pm_year
...
ss1 <- (gg_iav_zz_on + gg_zz_on_year) / (gg_lt_cAtot_year + gg_lt_pm_anet_year)
