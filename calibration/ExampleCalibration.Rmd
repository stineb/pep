...
=======
>>>>>>> 1712fc40ab8694404c9d4fbf7fb8a0cac15c5ec8
library(phenor)
...
load("~/pep/calibration/data/preds.df_demo.RData")
...
<<<<<<< HEAD
optimal_pars <- optimize_parameters(par = NULL,
                                  predictor = c(preds.sub$temp_GS,preds.sub$RD_summer), #xxx? c(preds.sub$temp_GS,preds.sub$RD_summer)
=======
optimal_pars <- pr_fit_parameters(par = NULL,
...
<<<<<<< HEAD
opt_pars.sub$c_TPDM <- optimal_pars$par[4]
...
3. Observed versus predicted autumn senescence dates for the timeseries.
Predictions calculated with the estimate_phenology function from phenor package v1.0
=======
...
PlotTPM <- ggplot(data = DoYoff_Preds.df_site_species, aes(x = Preds_AnomDoYoff_TPM, y = Obs_AnomDoYoff)) + geom_point() + 
  ...
  labs(title = "Predicted calibration",
              subtitle = "Model TPM",
              caption = "")
