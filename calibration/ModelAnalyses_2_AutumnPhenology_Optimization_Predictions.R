...
SecondGen_PIA.models = function(par, predictor, data) {
  ...
  for(col in 1:ncol(data$Tmini)) {
    interval = 1:366
    t0A = interval[which(data$Li[,col] < 173)] #xxx? P_base instead of 173
    ind1 = min(which(t0A > 173))
    t0A = t0A[ind1]
    t0 = c(t0,t0A)
  }
...
for(sp in 1:length(species)) {
  ...
  for(site in 1:length(sites)) {
    ...
    ts <- paste0(species[sp],"_",sites[site]) #xxx? sites[site],"_",species[sp]
    ...
    opt_pars.sub <- data.frame(timeseries=data.sub$site, Species=species[sp], PEP_ID=sites) #xxx? ts instead of data.sub$site and sites[site] instead of sites
    ...
    opt_pars.sub$Tbase_CDD <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$Fcrit_CDD <- optimal_pars[2] #xxx? optimal_pars$par[2]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        upper = c(30,16,0),
                                        control = list(max.call = 40000))
    opt_pars.sub$Tbase_DM1 <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$Pbase_DM1 <- optimal_pars[2] #xxx? optimal_pars$par[2]
    opt_pars.sub$Fcrit_DM1 <- optimal_pars[3] #xxx? optimal_pars$par[3]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        upper = c(30,16,0),
                                        control = list(max.call = 40000))
    opt_pars.sub$Tbase_DM2 <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$Pbase_DM2 <- optimal_pars[2] #xxx? optimal_pars$par[2]
    opt_pars.sub$Fcrit_DM2 <- optimal_pars[3] #xxx? optimal_pars$par[3]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        control = list(max.call = 40000))
    opt_pars.sub$Pbase_TPM <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$a_TPM <- optimal_pars[2]     #xxx? optimal_pars$par[2]
    opt_pars.sub$b_TPM <- optimal_pars[3]     #xxx? optimal_pars$par[3]
    opt_pars.sub$Fcrit_TPM <- optimal_pars[4] #xxx? optimal_pars$par[4]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        control = list(max.call = 40000))
    opt_pars.sub$Pbase_SIAM <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$a_SIAM <- optimal_pars[2]     #xxx? optimal_pars$par[2]
    opt_pars.sub$b_SIAM <- optimal_pars[3]     #xxx? optimal_pars$par[3]
    opt_pars.sub$c_SIAM <- optimal_pars[4]     #xxx? optimal_pars$par[4]
    opt_pars.sub$d_SIAM <- optimal_pars[5]     #xxx? optimal_pars$par[5]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        upper = c(16,0.1,250,300,1),
                                        control = list(max.call = 40000))
    opt_pars.sub$Pbase_TDM <- optimal_pars[1] #xxx? optimal_pars$par[1]
    opt_pars.sub$a_TDM <- optimal_pars[2]     #xxx? optimal_pars$par[2]
    opt_pars.sub$b_TDM <- optimal_pars[3]     #xxx? optimal_pars$par[3]
    opt_pars.sub$c_TDM <- optimal_pars[4]     #xxx? optimal_pars$par[4]
    opt_pars.sub$d_TDM <- optimal_pars[5]     #xxx? optimal_pars$par[5]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        upper = c(16,0.1,250,300,1),
                                        control = list(max.call = 40000))
    opt_pars.sub$Pbase_PIAgsi <- optimal_pars[1]    #xxx? optimal_pars$par[1]
    opt_pars.sub$a_PIAgsi <- optimal_pars[2]        #xxx? optimal_pars$par[2]
    opt_pars.sub$b_PIAgsi <- optimal_pars[3]        #xxx? optimal_pars$par[3]
    opt_pars.sub$c_PIAgsi <- optimal_pars[4]        #xxx? optimal_pars$par[4]
    opt_pars.sub$d_PIAgsi <- optimal_pars[5]        #xxx? optimal_pars$par[5]
    ...
    optimal_pars <- optimize_parameters(par = NULL,
                                        ...
                                        upper = c(16,0.1,250,300,1),
                                        control = list(max.call = 40000))
    opt_pars.sub$`Pbase_PIA-` <- optimal_pars[1]  #xxx? optimal_pars$par[1]
    opt_pars.sub$`a_PIA-` <- optimal_pars[2]      #xxx? optimal_pars$par[2]
    opt_pars.sub$`b_PIA-` <- optimal_pars[3]      #xxx? optimal_pars$par[3]
    opt_pars.sub$`c_PIA-` <- optimal_pars[4]      #xxx? optimal_pars$par[4]
    opt_pars.sub$`d_PIA-` <- optimal_pars[5]      #xxx? optimal_pars$par[5]
    DoYoff_Preds.sub$`Pred_DoYoff_PIA-` <- estimate_phenology(par = optimal_pars$par,
                                                              predictor = preds.sub$`cA_tot`, #xxx `cA_tot-w`
                                                              data = data.sub,
                                                              model = "SecondGen_PIA.models")
